...
export default function TradeMaterialsSection() {
  ...
  useEffect(() => {
    console.log('🔧 TradeMaterialsSection useEffect triggered:', {
      isReloading,
    ...
    if (isReloading) {
      console.log(
        '🔄 TradeMaterialsSection: Reloading, setting context items:',
    ...
    if (contextMaterialItems.length > 0) {
      console.log(
        '📥 TradeMaterialsSection: Context data available, setting local items:',
        contextMaterialItems
      );
      setLocalMaterialItems(contextMaterialItems);
      return;
    ...
    if (!userActionRef.current) {
      ...
      console.log('🔍 TradeMaterialsSection: Checking choices change:', {
        choicesString,
      ...
      if (choicesString !== processedChoicesRef.current) {
        ...
        console.log(
          '⚡ TradeMaterialsSection: Choices changed, generating new items'
        );
        ...
        design.selectedTrades?.forEach((tradeId) => {
          ...
          console.log(
            `🔨 TradeMaterialsSection: Processing trade ${tradeId}:`,
            {
        ...
        console.log(
          '✅ TradeMaterialsSection: Generated material items:',
          materialItems
        );
        setLocalMaterialItems(materialItems);
        console.log(
          '💾 TradeMaterialsSection: Calling setMaterialItems with:',
          materialItems
        );
  ...
  const handleItemChange = useCallback(
    (
      ...
      console.log('✏️ TradeMaterialsSection: handleItemChange called:', {
        id,
        field,
        value,
      ...
      const updatedItems = localMaterialItems.map((item) => {
        if (item.id === id) {
          ...
          console.log('🔄 TradeMaterialsSection: Updated item:', updatedItem);
          return updatedItem;
        }
        return item;
      });
      ...
      console.log(
        '📝 TradeMaterialsSection: Setting local items:',
        updatedItems
      );
      setLocalMaterialItems(updatedItems);

      console.log(
        '💾 TradeMaterialsSection: Calling setMaterialItems with updated items:',
        updatedItems
      );
  ...
  const handleDeleteItem = useCallback(
    (id: string) => {
      console.log('🗑️ TradeMaterialsSection: handleDeleteItem called:', {
        id,
        currentItems: localMaterialItems,
      });
      ...
      console.log(
        '📝 TradeMaterialsSection: Setting local items after delete:',
        updatedItems
      );
      setLocalMaterialItems(updatedItems);

      console.log(
        '💾 TradeMaterialsSection: Calling setMaterialItems after delete:',
        updatedItems
      );
      setMaterialItems('trade', updatedItems);
    },
  ...
  const handleAddCustomItem = useCallback(() => {
    const newItem: MaterialItem = {
      id: `custom-trade-material-${Date.now()}`,
      name: '',
      quantity: '1',
      unit: '',
      price: '0',
    ...
    console.log(
      '📝 TradeMaterialsSection: Setting local items with new custom item:',
      updatedItems
    );
    setLocalMaterialItems(updatedItems);
