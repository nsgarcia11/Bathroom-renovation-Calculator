...
export default function TradeMaterialsSection() {
  ...
  useEffect(() => {
    ...
    // Connect Sink Drain(s) materials - standalone with quantity
    ...
    // Install Vanity Faucet & Supply Lines materials - standalone with quantity
    ...
    // Shower Trim Components materials - individual selections
    if (design.showerTrimValve) {
      newMaterialItems.push({
    ...
    if (design.showerTrimShowerHead) {
      newMaterialItems.push({
        id: 'shower-head',
        name: 'Shower head',
        quantity: '1',
