...
export default function TradeLaborSection() {
  ...
  useEffect(() => {
    ...
    if (design.connectSinkDrains) {
      const taskId = 'connect_sink_drain';
      newLaborItems.push({
    ...
    if (design.installVanityFaucetSupplyLines) {
      const taskId = 'install_vanity_faucet';
      newLaborItems.push({
    ...
    if (design.showerTrimValve) {
      const taskId = 'install_shower_trim_valve';
      newLaborItems.push({
        id: 'install-shower-trim-valve',
        taskId,
        name: 'Shower Trim - Valve Trim',
        hours: getEffectiveHours(taskId, DEFAULT_HOURS[taskId]).toString(),
        rate: getEffectiveRate(taskId, 'plumbing').toString(),
        flatPrice: getEffectivePrice(taskId, FLAT_PRICES[taskId]).toString(),
        pricingMode: plumbingMode,
    ...
    if (design.showerTrimShowerHead) {
      const taskId = 'install_shower_head';
      newLaborItems.push({
        id: 'install-shower-head',
        taskId,
        name: 'Shower Trim - Shower Head',
        hours: getEffectiveHours(taskId, DEFAULT_HOURS[taskId]).toString(),
        rate: getEffectiveRate(taskId, 'plumbing').toString(),
        flatPrice: getEffectivePrice(taskId, FLAT_PRICES[taskId]).toString(),
        pricingMode: plumbingMode,
    ...
    if (design.showerTrimSpout) {
      ...
      newLaborItems.push({
        id: 'install-shower-trim-spout',
        taskId,
        name: 'Shower Trim - Spout',
        hours: getEffectiveHours(taskId, DEFAULT_HOURS[taskId]).toString(),
        rate: getEffectiveRate(taskId, 'plumbing').toString(),
        flatPrice: getEffectivePrice(taskId, FLAT_PRICES[taskId]).toString(),
        pricingMode: plumbingMode,
