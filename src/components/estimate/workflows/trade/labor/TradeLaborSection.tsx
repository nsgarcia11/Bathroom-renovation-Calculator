...
export default function TradeLaborSection() {
  ...
  useEffect(() => {
    ...
    if (design.vanityInstallationType === 'single') {
      const taskId = 'install_vanity_single';
      newLaborItems.push({
        id: 'install-vanity-cabinet-single',
        taskId,
        name: 'Install Vanity Cabinet (Single)',
        hours: getEffectiveHours(taskId, DEFAULT_HOURS[taskId]).toString(),
        rate: getEffectiveRate(taskId, 'plumbing').toString(),
        flatPrice: getEffectivePrice(taskId, FLAT_PRICES[taskId]).toString(),
        pricingMode: plumbingMode,
    ...
    if (design.vanityInstallationType === 'double') {
      const taskId = 'install_vanity_double';
      newLaborItems.push({
        id: 'install-vanity-cabinet-double',
        taskId,
        name: 'Install Vanity Cabinet (Double)',
        hours: getEffectiveHours(taskId, DEFAULT_HOURS[taskId]).toString(),
        rate: getEffectiveRate(taskId, 'plumbing').toString(),
        flatPrice: getEffectivePrice(taskId, FLAT_PRICES[taskId]).toString(),
        pricingMode: plumbingMode,
    ...
    if (design.vanityInstallationType === 'single' && design.connectSinkDrains) {
      const taskId = 'install_vanity_plumbing_single';
      newLaborItems.push({
    ...
    if (design.vanityInstallationType === 'double' && design.connectSinkDrains) {
      const taskId = 'install_vanity_plumbing_double';
      newLaborItems.push({
    ...
    // Faucet installation
    if (design.installVanityFaucetSupplyLines && design.vanityInstallationType === 'single') {
      const taskId = 'install_faucet_single';
      newLaborItems.push({
        id: 'install-vanity-faucet-supply-single',
        taskId,
    ...
    if (design.installVanityFaucetSupplyLines && design.vanityInstallationType === 'double') {
      const taskId = 'install_faucet_double';
      newLaborItems.push({
        id: 'install-vanity-faucet-supply-double',
        taskId,
        name: 'Install Vanity Faucets & Supply Lines (Double)',
        hours: getEffectiveHours(taskId, DEFAULT_HOURS[taskId]).toString(),
        rate: getEffectiveRate(taskId, 'plumbing').toString(),
        flatPrice: getEffectivePrice(taskId, FLAT_PRICES[taskId]).toString(),
        pricingMode: plumbingMode,
    ...
    // Shower Trim - Main option
    if (design.showerTrimOption === 'valve_head') {
      const taskId = 'install_shower_trim_valve_head';
      newLaborItems.push({
        id: 'install-shower-trim-valve-head',
        taskId,
        name: 'Shower Trim (Valve + Head)',
        hours: getEffectiveHours(taskId, DEFAULT_HOURS[taskId]).toString(),
        rate: getEffectiveRate(taskId, 'plumbing').toString(),
        flatPrice: getEffectivePrice(taskId, FLAT_PRICES[taskId]).toString(),
        pricingMode: plumbingMode,
    ...
    if (design.showerTrimOption === 'valve_head_spout') {
      const taskId = 'install_shower_trim_valve_head_spout';
      newLaborItems.push({
        id: 'install-shower-trim-valve-head-spout',
        taskId,
        name: 'Shower Trim (Valve + Head + Spout)',
        hours: getEffectiveHours(taskId, DEFAULT_HOURS[taskId]).toString(),
        rate: getEffectiveRate(taskId, 'plumbing').toString(),
        flatPrice: getEffectivePrice(taskId, FLAT_PRICES[taskId]).toString(),
        pricingMode: plumbingMode,
    ...
    if (design.installFreestandingTubFaucet) {
      ...
      newLaborItems.push({
        ...
        taskId,
        name: `Install Freestanding Tub & Faucet${hasRoughIn ? ' (Bundle)' : ''}`,
    ...
    if (design.vanityWallLightQuantity > 0) {
      ...
      newLaborItems.push({
        ...
        taskId,
        name: `Vanity / Wall Light Fixture(s) (x${design.vanityWallLightQuantity})`,
        hours: getEffectiveHours(taskId, DEFAULT_HOURS[taskId]).toString(),
        rate: getEffectiveRate(taskId, 'electrical').toString(),
        flatPrice: getEffectivePrice(taskId, FLAT_PRICES[taskId]).toString(),
        pricingMode: electricalMode,
    ...
    if (design.dimmerQuantity > 0) {
      ...
      newLaborItems.push({
        ...
        taskId,
        name: `Replace Light Switch with Dimmer (x${design.dimmerQuantity})`,
        hours: getEffectiveHours(taskId, DEFAULT_HOURS[taskId]).toString(),
        rate: getEffectiveRate(taskId, 'electrical').toString(),
        flatPrice: getEffectivePrice(taskId, FLAT_PRICES[taskId]).toString(),
        pricingMode: electricalMode,
    ...
    if (design.switchOutletQuantity > 0) {
      ...
      newLaborItems.push({
        ...
        taskId,
        name: `Replace Switch or Outlet (x${design.switchOutletQuantity})`,
        hours: getEffectiveHours(taskId, DEFAULT_HOURS[taskId]).toString(),
        rate: getEffectiveRate(taskId, 'electrical').toString(),
        flatPrice: getEffectivePrice(taskId, FLAT_PRICES[taskId]).toString(),
        pricingMode: electricalMode,
    ...
    if (design.showerPotLightQuantity > 0) {
      ...
      newLaborItems.push({
        ...
        taskId,
        name: `Replace Shower Pot Light (Wet-Rated) (x${design.showerPotLightQuantity})`,
        hours: getEffectiveHours(taskId, DEFAULT_HOURS[taskId]).toString(),
        rate: getEffectiveRate(taskId, 'electrical').toString(),
        flatPrice: getEffectivePrice(taskId, FLAT_PRICES[taskId]).toString(),
        pricingMode: electricalMode,
