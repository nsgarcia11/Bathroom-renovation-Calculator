...
export class ShowerWallsCalculator {
  ...
  static generateAutoLabor(
    ...
    // Shower Door Installation - Construction Labor
    if (design.showerDoor !== 'None') {
      // Create unique slug and determine hours based on door type
      let doorSlug = '';
      ...
      if (doorInstallHours > 0 && doorSlug) {
        // Door installation labor with unique ID and name per door type
        laborItems.push({
        ...
        // Blocking for shower door with unique ID per door type
        laborItems.push({
